...
//   }
//
//   // Alternative: Clear cart by removing all items via API
//   Future<void> clearCartViaAPI() async {
//     _isLoading = true;
//     notifyListeners();
//
//     try {
//       // Remove all items one by one
//       final List<int> cartIds = _cartItems.map((item) => item.cartId).toList();
...
//         } catch (e) {
//           allSuccess = false;
//           debugPrint('❌ Failed to remove cart item $cartId: $e');
//         }
//       }
//
...
//       if (allSuccess) {
//         if (kDebugMode) {
//           print('🛒 All cart items removed successfully');
//         }
//       } else {
//         if (kDebugMode) {
//           print('⚠️ Some cart items may not have been removed from server');
//         }
//       }
//     } catch (e) {
//       _error = 'Error clearing cart: $e';
